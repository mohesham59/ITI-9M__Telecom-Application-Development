...
//--------------------------------------------------
//--------------------------------------------------
int sum_all(Rectangle R, Triangle T, Square S, Circle C)
{
    return
        R.CalcArea() +
        T.CalcArea() +
...
//    GeoShape g;
    ...
    cout << "\n========================================\n";
    cout << "         Sum of all Shapes\n";
    cout << "========================================\n";
    cout << "Sum of all shapes is = " <<sum_all(rect,tri,sq,cir) << endl;
...
Circle::Circle(int radius) : GeoShape(radius, 0)
{
    cout << "Param Circle\n";
}
