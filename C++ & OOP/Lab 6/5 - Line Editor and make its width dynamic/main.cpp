...
int main()
{
    ...
    char* text = (char*) malloc(SIZE); //booking on Heap and mallco return *void so i use (char*) to return char
    ...
    while (true)
    {
        ...
        clrscr();
        cout << "Dynamic Single Line Editor (ESC to exit)\n";
        cout << "================================\n";
        cout << text << endl;
